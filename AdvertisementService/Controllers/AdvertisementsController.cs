...
namespace AdvertisementService.Controllers
{
    ...
    public class AdvertisementsController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAsync(string advertisementsId, string include, [FromQuery] Pagination pageInfo)
        {
            string institutionId = "0";
            dynamic response = await _advertisementsRepository.GetAdvertisementsAsync(institutionId, advertisementsId, include, pageInfo);
        ...
        public async Task<IActionResult> GetAdvertisementsByInstitutionsIdAsync(string institutionId, string advertisementsId, string include, [FromQuery] Pagination pageInfo)
        {
