...
namespace AdvertisementService.Controllers
{
    ...
    public class AdvertisementsController : ControllerBase
    {
        ...
        public IActionResult GetAsync(string advertisementsId, string include, [FromQuery] Pagination pageInfo)
        {
        ...
        public IActionResult GetAdvertisementsByInstitutionsIdAsync(string institutionId, string advertisementsId, string include, [FromQuery] Pagination pageInfo)
        {
