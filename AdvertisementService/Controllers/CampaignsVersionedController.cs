...
namespace AdvertisementService.Controllers
{
    ...
    public class CampaignsVersionedController : ControllerBase
    {
        private readonly ICampaignsRepository _campaignsRepository;
        private readonly advertisementserviceContext _context;
        private readonly AppSettings _appSettings;
        public CampaignsVersionedController(ICampaignsRepository campaignsRepository, advertisementserviceContext context, IOptions<AppSettings> appSettings)
        {
