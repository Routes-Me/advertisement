...
namespace AdvertisementService.Controllers
{
    ...
    public class AdvertisementsVersionedController : ControllerBase
    {
        private readonly IAdvertisementsRepository _advertisementsRepository;
        public AdvertisementsVersionedController(IAdvertisementsRepository advertisementsRepository)
        {
